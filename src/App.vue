      ...
      <v-main>
        <v-container>
          ...
          <v-row>
            ...
                    </v-list-item>
                </v-card>
                <!-- item.b_edit값을 통해 수정 모드인 경우 어둡게 표시 -->
                <v-card v-else dark>
                    <v-list-item class="py-2">
                      <v-list-item-action>
